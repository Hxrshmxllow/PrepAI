    ...
    return (
        <div className="login-container-div">
            ...
            <div className='login-page-container'>
                <h1 className='log-into-spotify-text'>Sign up for PrepAI</h1>
                ...
                <button className='login-page-login-button'>Sign Up</button>
                </form>
                <div className='login-page-sign-up-container'>
                <h2 className='login-page-dont-have-text'>Already have an account?</h2>
                <h2 className='login-page-sign-up-text' onClick={() => navigate('/login')}>Login to PrepAI.</h2>
                </div>
            </div>   
        </div>  
    );
